          ...
          <div className="navbar8-buttons">
            <button className="navbar8-action1 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <fragment>
                    <span className="navbar8-text13">Book Now</span>
                  </fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action2 thq-button-animated thq-button-outline">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <fragment>
                    <span className="navbar8-text07">Learn More</span>
                  </fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <fragment>
                                <span className="navbar8-text11 thq-body-small">
                                  Welcome to our Equine Therapy and Meditation
                                  Retreat center where you can find peace and
                            ...
                            {props.page2Description ?? (
                              <fragment>
                                <span className="navbar8-text09 thq-body-small">
                                  Learn more about our mission, values, and the
                                  team behind our Equine Therapy and Meditation
                                  Retreat.
                                </span>
                              </fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <fragment>
                                <span className="navbar8-text16 thq-body-small">
                                  Explore the various equine therapy and
                                  meditation services we offer to help you on
                        ...
                        <div className="navbar8-content3">
                          ...
                          <span>
                            {props.page4Description ?? (
                              <fragment>
                                <span className="navbar8-text08 thq-body-small">
                                  Get in touch with us to book a retreat, ask
                                  questions, or provide feedback. We are here to
                                  support you.
                                </span>
                              </fragment>
                            )}
                  ...
                  <div className="navbar8-content4">
                    ...
                    <span>
                      {props.page1Description ?? (
                        <fragment>
                          <span className="navbar8-text11 thq-body-small">
                            Welcome to our Equine Therapy and Meditation Retreat
                            center where you can find peace and connection with
                            nature.
                          </span>
                        </fragment>
                      )}
                      ...
                      {props.page2Description ?? (
                        <fragment>
                          <span className="navbar8-text09 thq-body-small">
                            ...
                            behind our Equine Therapy and Meditation Retreat.
                          </span>
                        </fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span>
                      {props.page3Description ?? (
                        <fragment>
                          <span className="navbar8-text16 thq-body-small">
                            Explore the various equine therapy and meditation
                            services we offer to help you on your journey to
...
Navbar8.defaultProps = {
  ...
  page4: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1452378174528-3090a4bba7b2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjU0NzI0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1495001258031-d1b407bc1776?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjU0NzI0N3w&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage2: '#about',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1711603108728-1e76cb8ca3d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjU0NzI0OXw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage3: '#services',
  linkUrlPage4: '#contact',
  page1ImageAlt: 'Image of a serene meditation space surrounded by nature',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1710845423442-1d030a0ad9e7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjU0NzI0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  page4Description: undefined,
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page2ImageAlt:
    'Image of people interacting with horses in a peaceful setting',
  link2Url: '#about',
  page2Description: undefined,
  logoAlt: 'Equine Therapy and Meditation Retreat',
  page3ImageAlt: 'Image of horses in a tranquil natural environment',
  link1Url: '#home',
  page2: undefined,
  ...
  page4ImageAlt: 'Image of a horse grazing peacefully in a meadow',
  page1: undefined,
}
