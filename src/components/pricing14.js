        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <fragment>
                  <span className="pricing14-text094 thq-heading-2">
                    Pricing plan
                  </span>
                </fragment>
              )}
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  <p>
                    {props.plan1 ?? (
                      <fragment>
                        <span className="pricing14-text056 thq-body-large">
                          Basic plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <fragment>
                        <span className="pricing14-text075 thq-body-large">
                          $1500 for 12 sessions
                        </span>
                      </fragment>
                    )}
                  </p>
                ...
                <div className="pricing14-list">
                  <div className="pricing14-list-item">
                    ...
                    <span>
                      {props.plan1Feature1 ?? (
                        <fragment>
                          <span className="pricing14-text087 thq-body-small">
                            1-hour equine therapy session
                          </span>
                        </fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  <p>
                    {props.plan2 ?? (
                      <fragment>
                        <span className="pricing14-text070 thq-body-large">
                          Business plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <fragment>
                        <span className="pricing14-text071 thq-heading-3">
                          $250 per session
                        </span>
                      </fragment>
                    )}
                  ...
                  <p>
                    {props.plan2Yearly ?? (
                      <fragment>
                        <span className="pricing14-text073 thq-body-large">
                          $2500 for 12 sessions
                        </span>
                      </fragment>
                    )}
                  </p>
                      ...
                      {props.plan2Feature1 ?? (
                        <fragment>
                          <span className="pricing14-text078 thq-body-small">
                            1.5-hour equine therapy session
                          </span>
                        </fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <fragment>
                        <span className="pricing14-text080 thq-heading-3">
                          $350 per session
                        </span>
                      </fragment>
                    )}
                      ...
                      {props.plan3Feature1 ?? (
                        <fragment>
                          <span className="pricing14-text079 thq-body-small">
                            2-hour equine therapy and meditation session
                          </span>
                        </fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  <span>
                    {props.plan11 ?? (
                      <fragment>
                        <span className="pricing14-text063 thq-body-large">
                          Basic plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <fragment>
                        <span className="pricing14-text077 thq-heading-3">
                          $200/yr
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  <span>
                    {props.plan21 ?? (
                      <fragment>
                        <span className="pricing14-text072 thq-body-large">
                          Business plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <fragment>
                        <span className="pricing14-text065 thq-body-large">
                          or $29 monthly
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <fragment>
                        <span className="pricing14-text090 thq-heading-3">
                          $499/yr
                        </span>
                      </fragment>
                    )}
                  ...
                  <div className="pricing14-list-item20">
                    ...
                    <span>
                      {props.plan3Feature21 ?? (
                        <fragment>
                          <span className="pricing14-text067 thq-body-small">
                            Feature text goes here
                          </span>
                        </fragment>
                      )}
